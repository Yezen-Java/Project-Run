          ...
          <ul id="buttonsListTours">
           		...
           		<?php
              		...
              		$tour_name =$rows["tour_name"];
           			...
           			echo "<li id='$tour_id'> 
           					<div class='input-group'> <span class='glyphicon glyphicon-trash'> </span><button type='button' id='tourButton' class='list-group-item' value='$tour_id' onclick='w3_open(this.value)'>$tour_name $tour_id</button> </div> </li>";
              		}  
              	?>
