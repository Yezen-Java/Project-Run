          ...
          <ul id="buttonsListTours">
           		...
           		<?php
              		...
              		$tour_name =$rows["tour_name"];
           			...
           			echo "<li id='$tour_id'> 
           					<div class='input-group'> <span class='input-group-addon'> <button class='glyphicon glyphicon-trash' id='$tourid' onclick='deleteTourLi(this.value)'></button> </span><button type='button' class='list-group-item' value='$tour_id' onclick='w3_open(this.value)'>$tour_name $tour_id</button> </div> </li>";
              		}  
              	?>
